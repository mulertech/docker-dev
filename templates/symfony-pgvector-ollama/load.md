...
## To reload the database after deletion (with vector extension)
If you need to reload the database and ensure the vector extension is enabled, use the following commands:
```bash
